...
int main(int, char**)
{
    ...
    swl::variant<NotCopyConstructible> v;
    swl::variant<NotCopyConstructible> v1;
    swl::variant<NotCopyConstructible> v2(v); // expected-error {{call to implicitly-deleted copy constructor of 'swl::variant<NotCopyConstructible>'}}
