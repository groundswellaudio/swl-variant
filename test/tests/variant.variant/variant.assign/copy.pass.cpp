...
void test_copy_assignment_not_noexcept() {
  {
    using V = swl::variant<CopyMaybeThrows>;
    static_assert(!std::is_nothrow_copy_assignable<V>::value, "");
  }
  {
    using V = swl::variant<int, CopyDoesThrow>;
    static_assert(!std::is_nothrow_copy_assignable<V>::value, "");
  }
}
...
void test_copy_assignment_sfinae() {
  ...
  {
    using V = swl::variant<int, NTCopyAssign>;
    static_assert(!std::is_trivially_copy_assignable<V>::value, "");
    static_assert(std::is_copy_assignable<V>::value, "");
  }
  {
    using V = swl::variant<int, TCopyAssign>;
    static_assert(std::is_trivially_copy_assignable<V>::value, "");
  }
  {
    using V = swl::variant<int, TCopyAssignNTMoveAssign>;
    static_assert(std::is_trivially_copy_assignable<V>::value, "");
  }
  {
    using V = swl::variant<int, CopyOnly>;
...
void test_copy_assignment_same_index() {
  ...
  }
  {
    ...
    V v1(swl::in_place_type<CopyAssign>, 43);
  ...
  }
  {
    struct {
      constexpr Result<int> operator()() const {
        using V = swl::variant<int, TCopyAssign, unsigned>;
        V v(swl::in_place_type<TCopyAssign>, 43);
        V v2(swl::in_place_type<TCopyAssign>, 42);
        v = v2;
  ...
  }
  {
    struct {
      constexpr Result<int> operator()() const {
        using V = swl::variant<int, TCopyAssignNTMoveAssign, unsigned>;
        V v(swl::in_place_type<TCopyAssignNTMoveAssign>, 43);
        V v2(swl::in_place_type<TCopyAssignNTMoveAssign>, 42);
        v = v2;
        return {v.index(), swl::get<1>(v).value};
      }
    } test;
...
{
  const swl::variant<long, void*, int> cp(
