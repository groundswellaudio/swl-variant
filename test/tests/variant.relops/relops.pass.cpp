...
void test_equality_basic() {
  {
    using V = swl::variant<T1, T2>;
    constexpr V v1(swl::in_place_index<0>, T1{42});
    constexpr V v2(swl::in_place_index<0>, T1{42});
    static_assert(v1 == v2, "");
    static_assert(v2 == v1, "");
    static_assert(!(v1 != v2), "");
    static_assert(!(v2 != v1), "");
  }
  {
    using V = swl::variant<T1, T2>;
    constexpr V v1(swl::in_place_index<0>, T1{42});
    constexpr V v2(swl::in_place_index<0>, T1{43});
    static_assert(!(v1 == v2), "");
    static_assert(!(v2 == v1), "");
    static_assert(v1 != v2, "");
    static_assert(v2 != v1, "");
  }
  {
    using V = swl::variant<T1, T2>;
    constexpr V v1(swl::in_place_index<0>, T1{42});
    constexpr V v2(swl::in_place_index<1>, T2{42});
    static_assert(!(v1 == v2), "");
    static_assert(!(v2 == v1), "");
    static_assert(v1 != v2, "");
    static_assert(v2 != v1, "");
  ...
  {
    using V = swl::variant<T1, T2>;
    constexpr V v1(swl::in_place_index<1>, T2{42});
    constexpr V v2(swl::in_place_index<1>, T2{42});
    static_assert(v1 == v2, "");
    static_assert(v2 == v1, "");
    static_assert(!(v1 != v2), "");
...
void test_relational_basic() {
  { // same index, same value
    using V = swl::variant<T1, T2>;
    constexpr V v1(swl::in_place_index<0>, T1{1});
    constexpr V v2(swl::in_place_index<0>, T1{1});
    static_assert(test_less(v1, v2, false, false), "");
  }
  { // same index, value < other_value
    using V = swl::variant<T1, T2>;
    constexpr V v1(swl::in_place_index<0>, T1{0});
    constexpr V v2(swl::in_place_index<0>, T1{1});
  ...
  { // same index, value > other_value
    using V = swl::variant<T1, T2>;
    constexpr V v1(swl::in_place_index<0>, T1{1});
    constexpr V v2(swl::in_place_index<0>, T1{0});
    static_assert(test_less(v1, v2, false, true), "");
  }
  { // LHS.index() < RHS.index()
    using V = swl::variant<T1, T2>;
    constexpr V v1(swl::in_place_index<0>, T1{0});
    constexpr V v2(swl::in_place_index<1>, T2{0});
    static_assert(test_less(v1, v2, true, false), "");
  }
  { // LHS.index() > RHS.index()
    using V = swl::variant<T1, T2>;
    constexpr V v1(swl::in_place_index<1>, T2{0});
    constexpr V v2(swl::in_place_index<0>, T1{0});
    static_assert(test_less(v1, v2, false, true), "");
  }
}
